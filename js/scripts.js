    ...
    const enlaceDestino = document.querySelector('a.contacto__enlace');



    //Evento para ajustar la posicion del formulario en el scroll.
    enlaceDestino.addEventListener('click', function(e) {
    e.preventDefault();
    location.hash = e.target.hash; 
    const alturaMenu = -80; 
    window.scrollBy(0, alturaMenu);
    });
    ...
    //Función para desplegar mensaje en pantalla.
    ...
    //Función que ocupa el servicio de un tercero para enviar correos. (EmailJS)
